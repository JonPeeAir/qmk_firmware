...
* `-------------+------+------+------+------|------|     |------|-----------------------------------------'
*               | RGB  | WIN  | LALT | LOWR | SPCE |     | SPCE | RISE | RALT | CAPS | GAME |
*               `----------------------------------'     `----------------------------------'
*/
  [_QWERTY] = LAYOUT(
//,-----------------------------------------------------------.                             ,-----------------------------------------------------------.
...
//|---------+---------+---------+-------------------+---------|---------|         |---------|---------+---------+---------+---------+---------+---------|
                        UG_TOGG , KC_LGUI , KC_LALT , KC_LOWR , KC_SPC  ,           KC_SPC  , KC_UPPR , KC_RALT , KC_CAPS , XXXXXXX
//                    `-------------------------------------------------'         `-------------------------------------------------'
  ),
...
//|---------+---------+---------+---------+---------+---------|                             |---------+---------+---------+---------+---------+---------|
    _______ , XXXXXXX , XXXXXXX , KC_LSFT , XXXXXXX , KC_CAPS,                                KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT , _______ , KC_ENT  ,
//|---------+---------+---------+-------------------+---------|---------.         ,---------|---------+---------+---------+---------+---------+---------|
    _______ , XXXXXXX , XXXXXXX , KC_COPY , KC_PSTE , XXXXXXX , _______ ,           _______ , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX ,
//|---------+---------+---------+-------------------+---------|---------|         |---------|---------+---------+---------+---------+---------+---------|
                        _______ , _______ , _______ , _______ , _______ ,           _______ , _______ , _______ , _______ , _______
//                    `-------------------------------------------------'         `-------------------------------------------------'
  ),
